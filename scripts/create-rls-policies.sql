-- ISTExpert: RLS политики и индексы
-- Выполните ПОСЛЕ создания таблиц (create-tables.sql)
-- Supabase SQL Editor: https://supabase.com/dashboard/project/plsaqkfxrrtgnrhmmcho/sql/new
